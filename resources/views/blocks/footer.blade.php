<footer class="footer-area footer-area-3 bg-black-2 footer-3 pt-100">
                ...
                <div class="col-xxl-3 col-lg-4 footer-address-col">
                    ...
                    <div class="f-address">
                        <ul>
                            ...
                            <li>
                                <span>E-mail:</span>
                                <p><a href="https://www.devsnews.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c7a3a2aaa887a2bfa6aab7aba2e9a4a8aa">[email&#160;protected]</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-copyright-2 bg-black-2-i ">
        <div class="container">
            <div class="row">
                <div class="col-xxl-3 col-lg-3 mb-20 mb-lg-0">
                    <img src="assets/img/icon/payment.png" alt="">
                </div>
                <div class="col-xxl-9 col-lg-9 text-lg-end">
                    <p>Copyrights © 2021 EPIXX - Powered By <a href="https://devsnews.com/template/epixx-prev/epixx/bdevs.net/">BDevs</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Danh sách người hỗ trợ</h4>
                </div>
                <div class="list-group chat-list" id="chatList" style="max-height: 500px; overflow-y: auto;">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center chat-item">
                            <img src="https://i.pinimg.com/236x/5e/e0/82/5ee082781b8c41406a2a50a0f32d6aa6.jpg" class="profile_img rounded-circle mr-3" style="width: 40px; height: 40px;" alt="Profile Picture">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="mb-0" id="chat_name">Liên hệ với</h4>
                    </div>
                </div>
                ...
                let messageHtml = `
                    <div class="chat-message receiver"> <!-- Left alignment for received messages -->
                        <div class="message-avatar">
                            <img src="https://i.pinimg.com/236x/5e/e0/82/5ee082781b8c41406a2a50a0f32d6aa6.jpg" class="rounded-circle avatar" alt="${senderName} Avatar">
                        </div>
